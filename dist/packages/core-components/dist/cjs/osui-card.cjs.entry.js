...
const OSUICard = class {
  ...
  borderChanged(newValue) {
    utils.setStyleAttribute(this.selfElement, CssCustomProperties.Border, `var(--border-radius-${newValue})`);
  }
  backgroundChanged(newValue) {
    utils.setStyleAttribute(this.selfElement, CssCustomProperties.BackgroundColor, newValue);
  }
  ...
  render() {
    return [
      index.h("header", { class: 'osui-card__header', part: 'header' }, index.h("slot", { name: 'header' }, "Insert Your Header")),
      index.h("div", { class: 'osui-card__content', part: 'content' }, index.h("slot", { name: 'content' }, "Insert Your Content")),
      index.h("footer", { class: 'osui-card__footer', part: 'footer' }, index.h("slot", { name: 'footer' }, "Insert Your Footer Content"))
    ];
  }
  get selfElement() { return index.getElement(this); }
...
exports.osui_card = OSUICard;

//# sourceMappingURL=osui-card.cjs.entry.js.map